                ...
                <table class="table" id="zero_config">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr>
                            <td>1</td>
                            <td>
                                <a href="javascript:void(0);" class="btn btn-primary btn-sm" onclick="viewDetails('General Employee', 'John', 'Em-001', 'Kolkata', 'New Town', 'Driver', '0123456789', 'john@gmail.com', 'Wb 20E 2356', 'Approved', '{{ URL::to('public/assets/admin/img/logo/driver.jpeg') }}', '{{ URL::to('public/assets/admin/img/logo/aadhar.png') }}', '{{ URL::to('public/assets/admin/img/logo/pan.jpeg') }}')">View</a>
                            </td>
